...
import 'package:onlineorder/ui_view/character_list_item_Qr.dart';
import 'package:onlineorder/ui_view/character_search_input_sliver.dart';


class ListViewQr extends StatefulWidget {
  const ListViewQr({Key? key}) : super(key: key);

  @override
  _ListViewQrState createState() => _ListViewQrState();
}

class _ListViewQrState extends State<ListViewQr> {
